...
public class ClassicScore extends AppCompatActivity {
    ...
    TextView gameOverTitleLeftTextView ;
    TextView gameOverTitleRightTextView ;
    TextView gameOverTitleMiddleTextView ;
    ...
    private void initScore()
    {
        ...
        animation.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                int playersScore = preferences.getInt("HighScoreClassic", 0);
